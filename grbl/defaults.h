...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_ACCELERATION (0.1*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (0.1*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (0.1*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
