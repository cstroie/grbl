...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 4096.0
  #define DEFAULT_Y_STEPS_PER_MM 4096.0
  #define DEFAULT_Z_STEPS_PER_MM 4096.0
  #define DEFAULT_X_MAX_RATE 20.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 20.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 200.0 // mm/min
  #define DEFAULT_X_ACCELERATION (0.05*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (0.05*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (0.05*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 90.0 // rpm
